    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Ingresa a tu cuenta para gestionar tu dinero e inteligencia artificial</p>
        </div>
        ...
        <Card className="border-border/80 shadow-xl backdrop-blur-sm bg-card/95">
          <CardHeader className="space-y-1 pb-4">
            <CardTitle className="text-lg font-bold">Iniciar Sesión ({accountType === "business" ? "Portal Marcas" : "Personal"})</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="relative flex items-center justify-center my-2">
              ...
              <span className="bg-card px-2 text-[10px] text-muted-foreground uppercase font-semibold relative z-10">o con correo</span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {loading ? "Ingresando..." : "Ingresar a Liora"}
          ...
          <CardFooter className="flex justify-center border-t border-border pt-4 text-xs text-muted-foreground">
            ...
            <Link href="/register" className="font-bold text-emerald-600 hover:underline ml-1">
              Regístrate gratis
            </Link>
          </CardFooter>
        </Card>
